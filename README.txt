...
The goal of this project is to gain a better understainding of the different of the different clustering algorithms, dimension reduction techniques and the limitations of each. :

 Mushroom classification - Custom dataset, original was from https://www.kaggle.com/uciml/mushroom-classification I added noise to the dataset so you must download mushrooms.csv file from this repository. 


Dataset: Survey Response (city/Rural) Dataset: https://www.kaggle.com/miroslavsabo/young-people-survey
